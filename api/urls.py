...
urlpatterns = [
    ...
    path('alignments/get_reference_sequences_meta_data/', alignments.get_reference_sequences_meta_data, name='get_reference_sequences_meta_data'),
    path('alignments/get_reference_sequence/<str:primary_accession>', alignments.get_reference_sequence, name='get_reference_sequence'),
    path('alignments/run_blast_search/<str:query>', alignments.run_blast_search, name='run_blast_search'),
    ...
    #Tasks
    path('get_job_logs/<str:job_id>', tasks.get_job_logs, name='get_job_logs'),
    path('get_job_result/<str:job_id>', tasks.get_job_result, name='get_job_result'),
    path('tasks/run_sequence_alignment/', tasks.run_sequence_alignment, name='run_sequence_alignment'),

    path('get_blast_results/<str:file_path>', tasks.get_blast_results, name='get_blast_results'),
    path('get_nextAlign_results/<str:file_path>', tasks.get_nextAlign_results, name='get_nextAlign_results'),
    ...
    path('get_filtered_sequences/', sequences.get_filtered_sequences, name='get_filtered_sequences'),
    ...
    path('search_sequence/<str:sequence>',sequences.search_sequence, name='search_sequence'),
